...
use xh5for
  ...
  include 'mpif.h'
    ...
    call xh5%Open(FilePrefix='xh5for_ch_unstructured_tetrahedron_non_static', Strategy=XDMF_STRATEGY_CONTIGUOUS_HYPERSLAB, Action=XDMF_ACTION_WRITE)
    ...
    !< Read XDMF/HDF5 file
    call xh5%Open(FilePrefix='xh5for_ch_unstructured_tetrahedron_non_static', Strategy=XDMF_STRATEGY_CONTIGUOUS_HYPERSLAB, Action=XDMF_ACTION_READ)
