...
contains
    ...
    subroutine hdf5_contiguous_hyperslab_WriteTopology_R4P(this, Coordinates)
    !-----------------------------------------------------------------
...
#endif
    end subroutine hdf5_contiguous_hyperslab_WriteTopology_R4P



    subroutine hdf5_contiguous_hyperslab_WriteTopology_R8P(this, Coordinates)
    !-----------------------------------------------------------------
    ...
    !-----------------------------------------------------------------
        ...
        call H5Sclose_f(space_id = filespace, hdferr = hdferror)
#endif
    end subroutine hdf5_contiguous_hyperslab_WriteTopology_R8P


    subroutine hdf5_contiguous_hyperslab_WriteGeometry_I4P(this, Connectivities)
    !-----------------------------------------------------------------
    !< Writes I4P connectivities to a HDF5 file for the contiguous HyperSlab strategy
    !----------------------------------------------------------------- 
        class(hdf5_contiguous_hyperslab_handler_t), intent(IN) :: this                   !< HDF5 contiguous hyperslab handler
        integer(I4P)                                           :: Connectivities(:)      !< Grid connectivities
    ...
    !-----------------------------------------------------------------
        ...
        call H5Sclose_f(space_id = filespace, hdferr = hdferror)
#endif
    end subroutine hdf5_contiguous_hyperslab_WriteGeometry_I4P
