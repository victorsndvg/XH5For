...
private
    ...
    contains
    private
        procedure(xdmf_dataset_per_process_handler_WriteGeometry), deferred :: WriteGeometry
        procedure(xdmf_dataset_per_process_handler_WriteTopology), deferred :: WriteTopology
        procedure         :: CalculateAttributeDimensions => xdmf_dataset_per_process_handler_CalculateAttributeDimensions
        procedure         :: AppendAttribute_I4P          => xdmf_dataset_per_process_handler_AppendAttribute_I4P
        procedure         :: AppendAttribute_I8P          => xdmf_dataset_per_process_handler_AppendAttribute_I8P
        procedure         :: AppendAttribute_R4P          => xdmf_dataset_per_process_handler_AppendAttribute_R4P
        procedure         :: AppendAttribute_R8P          => xdmf_dataset_per_process_handler_AppendAttribute_R8P
        procedure         :: WriteAttributes              => xdmf_dataset_per_process_handler_WriteAttributes
        procedure, public :: GetUniqueNodeByTag           => xdmf_dataset_per_process_handler_GetUniqueNodeByTag
        procedure, public :: GetFirstChildByTag           => xdmf_dataset_per_process_handler_GetFirstChildByTag
        procedure, public :: GetDataItemXPath             => xdmf_dataset_per_process_handler_GetDataItemXPath
        procedure         :: OpenGrid                     => xdmf_dataset_per_process_handler_OpenGrid
        procedure         :: CloseGrid                    => xdmf_dataset_per_process_handler_CloseGrid
        procedure, public :: OpenFile                     => xdmf_dataset_per_process_handler_OpenFile
        procedure, public :: Serialize                    => xdmf_dataset_per_process_handler_Serialize
        procedure, public :: CloseFile                    => xdmf_dataset_per_process_handler_CloseFile
        procedure, public :: Free                         => xdmf_dataset_per_process_handler_Free
    end type xdmf_dataset_per_process_handler_t

    abstract interface
        subroutine xdmf_dataset_per_process_handler_WriteGeometry(this, GridID)
            import I4P
            import xdmf_dataset_per_process_handler_t
        ...
        end subroutine xdmf_dataset_per_process_handler_WriteGeometry

        subroutine xdmf_dataset_per_process_handler_WriteTopology(this, GridID)
            import I4P
            import xdmf_dataset_per_process_handler_t
            class(xdmf_dataset_per_process_handler_t), intent(INOUT) :: this    !< XDMF dataset per process handler
            integer(I4P),                              intent(IN) :: GridID     !< Grid ID number
        end subroutine xdmf_dataset_per_process_handler_WriteTopology
    end interface
...
contains
    ...
    subroutine xdmf_dataset_per_process_handler_OpenGrid(this, GridID)
    !-----------------------------------------------------------------
    !< Open a XDMF grid
    !----------------------------------------------------------------- 
        class(xdmf_dataset_per_process_handler_t), intent(INOUT) :: this        !< XDMF dataset per process handler
    ...
    end subroutine xdmf_dataset_per_process_handler_OpenGrid


    subroutine xdmf_dataset_per_process_handler_CloseGrid(this)
    !-----------------------------------------------------------------
    !< Close a XDMF grid
    !----------------------------------------------------------------- 
        class(xdmf_dataset_per_process_handler_t), intent(INOUT) :: this        !< XDMF dataset per process handler
    ...
    end subroutine xdmf_dataset_per_process_handler_CloseGrid


    subroutine xdmf_dataset_per_process_handler_Free(this)
    !-----------------------------------------------------------------
    !< Free XDMF file handler
    !----------------------------------------------------------------- 
        class(xdmf_dataset_per_process_handler_t), intent(INOUT) :: this !< XMDF handler
        integer(I4P)                                             :: indx
    !----------------------------------------------------------------- 
    ...
    end subroutine xdmf_dataset_per_process_handler_Free


    subroutine xdmf_dataset_per_process_handler_AppendAttribute_I4P(this, Name, Type, Center, Attribute)
    !-----------------------------------------------------------------
    ...
    end subroutine xdmf_dataset_per_process_handler_AppendAttribute_I4P


    subroutine xdmf_dataset_per_process_handler_AppendAttribute_I8P(this, Name, Type, Center, Attribute)
    !-----------------------------------------------------------------
    ...
    end subroutine xdmf_dataset_per_process_handler_AppendAttribute_I8P


    subroutine xdmf_dataset_per_process_handler_AppendAttribute_R4P(this, Name, Type, Center, Attribute)
    !-----------------------------------------------------------------
    ...
    end subroutine xdmf_dataset_per_process_handler_AppendAttribute_R4P


    subroutine xdmf_dataset_per_process_handler_AppendAttribute_R8P(this, Name, Type, Center, Attribute)
    !-----------------------------------------------------------------
    !< Add R4P attribute info to the handler. Used in deferred writing 
    !----------------------------------------------------------------- 
        class(xdmf_dataset_per_process_handler_t), intent(INOUT) :: this         !< XDMF dataset per process handler
    ...
    end subroutine xdmf_dataset_per_process_handler_AppendAttribute_R8P


    subroutine xdmf_dataset_per_process_handler_CalculateAttributeDimensions(this, GridID, Center, GlobalNumberOfData, LocalNumberOfData, DataOffset)
    !-----------------------------------------------------------------
    !< Calculate hyperslab dimensions for the dataset per process strategy
    !----------------------------------------------------------------- 
        class(xdmf_dataset_per_process_handler_t), intent(IN)  :: this                !< xmdf dataset per process handler
    ...
    end subroutine xdmf_dataset_per_process_handler_CalculateAttributeDimensions


    subroutine xdmf_dataset_per_process_handler_OpenFile(this, action, fileprefix)
    !-----------------------------------------------------------------
    !< Open a XDMF file for the dataset per process strategy
    !----------------------------------------------------------------- 
        class(xdmf_dataset_per_process_handler_t), intent(INOUT) :: this       !< XDMF dataset per process handler
    ...
    end subroutine xdmf_dataset_per_process_handler_OpenFile


    function xdmf_dataset_per_process_handler_GetUniqueNodeByTag(this, FatherNode, Tag) result(ChildNode)
    !-----------------------------------------------------------------
    ...
    !----------------------------------------------------------------- 
        ...
        nullify(Childrens)
    end function xdmf_dataset_per_process_handler_GetUniqueNodeByTag


    function xdmf_dataset_per_process_handler_GetFirstChildByTag(this, FatherNode, Tag) result(ChildNode)
    !-----------------------------------------------------------------
    !< Return the first FoX DOM child node given a father node
    !----------------------------------------------------------------- 
        class(xdmf_dataset_per_process_handler_t), intent(INOUT) :: this       !< XDMF dataset per process handler
    ...
    !----------------------------------------------------------------- 
        ...
        nullify(Childrens)
    end function xdmf_dataset_per_process_handler_GetFirstChildByTag


    function xdmf_dataset_per_process_handler_GetDataItemXPath(this, DataItemNode) result(XPath)
    !-----------------------------------------------------------------
    ...
    !----------------------------------------------------------------- 
        ...
        nullify(ChildNode)
        call dataitem%Free()
    end function xdmf_dataset_per_process_handler_GetDataItemXPath


    subroutine xdmf_dataset_per_process_handler_CloseFile(this)
    !-----------------------------------------------------------------
    !< Close a XDMF file for the dataset per process strategy
    ...
    end subroutine xdmf_dataset_per_process_handler_CloseFile


    subroutine xdmf_dataset_per_process_handler_Serialize(this)
    !-----------------------------------------------------------------
    ...
    !----------------------------------------------------------------- 
        do IDidx=0, this%MPIEnvironment%get_comm_size()-1
            ...
            call this%CloseGrid()
        enddo
    end subroutine xdmf_dataset_per_process_handler_Serialize
