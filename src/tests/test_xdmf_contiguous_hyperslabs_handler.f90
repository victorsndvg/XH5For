...
#endif
    call lightdata%initialize(NumberOfNodes=100_I8P, NumberOfElements=50_I8P, TopologyType=XDMF_TOPOLOGY_TYPE_TRIANGLE, GeometryType=XDMF_GEOMETRY_TYPE_XYZ)
    call lightdata%OpenFile('hyperslab.xmf')
    do i=1, lightdata%mpi_env%get_comm_size()
